...
import DashboardPage from "./main menu item/DashboardPage";
import UsersPage from "./main menu item/UsersPage";
import CalendarPage from "./main menu item/CalendarPage";
import EventsPage from "./main menu item/EventsPage";
import LeavePage from "./main menu item/LeavePage";
import StaffPage from "./hospital menu items/StaffPage";
import PatientsPage from "./hospital menu items/PatientsPage";
import LaboratoryPage from "./hospital menu items/LaboratoryPage";
import BillingPage from "./hospital menu items/BillingPage";
...
const Main = styled("main", {
  ...
  padding: isMobile 
  ? theme.spacing(3) 
  : `${theme.spacing(3)}px 5px ${theme.spacing(3)}px 5px`, // format: top right bottom left
transition: theme.transitions.create('margin', {
  easing: theme.transitions.easing.sharp,
  duration: theme.transitions.duration.leavingScreen
}),
// Reduce or eliminate additional marginLeft when drawer is open
marginLeft: isMobile ? 0 : (open ? 0 : 0), // Remove the drawerWidth margin
}));
